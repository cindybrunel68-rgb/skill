...
4. Capture key relationship facts to Claude Code's native auto-memory at `~/.claude/projects/-root-aios/memory/relationships.md` (create the topic file if absent, append otherwise). Add a pointer line in `MEMORY.md` if a new topic is created.
