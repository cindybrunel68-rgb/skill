...
The Local Edition does not ship a one-command installer for this optional layer.
Set it up manually with the five short steps below (it takes a couple of minutes).
The `business-setup` wizard can also collect your OpenAI + Pinecone keys during
onboarding if you have them.
